...
c         MMDIM = NCDID(CDFID,'m-wave+1',IRET)
c         NNDIM = NCDID(CDFID,'n-wave+1',IRET)
         MMDIM = NCDID(CDFID,'m-wave_1',IRET)
         NNDIM = NCDID(CDFID,'n-wave_1',IRET)
...
c         MMDIM = NCDDEF(CDFID,'m-wave+1',RTRUNC+1,IRET)
c         NNDIM = NCDDEF(CDFID,'n-wave+1',RTRUNC+1,IRET)
         MMDIM = NCDDEF(CDFID,'m-wave_1',RTRUNC+1,IRET)
         NNDIM = NCDDEF(CDFID,'n-wave_1',RTRUNC+1,IRET)
...
c      CALL NCVPT1(CDFID,TIMEID,DIMS,TAU,IRET)
      CALL prnttau(CDFID,TIMEID,DIMS,TAU,IRET)
      IF (IRET .NE. 0) THEN
         WRITE(0,670)
