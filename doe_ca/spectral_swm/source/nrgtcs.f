...
C                                                                               
      ...
      SAVE TE, PE, APE
      REAL AAM(NGRPHS), TMSS(NGRPHS), TME(NGRPHS), HTS(NGRPHS)
      SAVE AAM, TMSS, TME, HTS
C
...
C
         ...
         ENDIF
C
C        WRITE NORMALIZATION DATA
C
         WRITE(6,906) PLATG, PLONG, TMSSN, TOTEN, PEN
...
C
      TME (ICTR) = TAU                                                          
C
C     WRITE NORMALIZED DATA
C
      WRITE(6,988) TMSS(ICTR),TE(ICTR),TAPE,TAM,PE(ICTR),
     $             H(ILON,JLAT)
  988 FORMAT (/,
     $           ' NORMALIZED MASS       = ',1PE16.9,/,
     $           ' NORM. TOTAL ENERGY    = ',1PE16.9,/,
     $           ' VORTICITY             = ',1PE16.9,/,
     $           ' DIVERGENCE            = ',1PE16.9,/,
     $           ' NORM. POT. ENSTROPHY  = ',1PE16.9,/,
